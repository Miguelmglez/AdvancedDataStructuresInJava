...
public class LinkedTree<E> implements Tree<E> {
    ...
    private class LinkedTreeIterator<T> implements Iterator<Position<T>> {
        ...
        private Queue<TreeNode<T>> nodeQueue = new ArrayDeque<TreeNode<T>>();
    ...
    public void preOrderAux(Position<E> p, List<Position<E>> pos)
            throws InvalidPositionException {
        pos.add(p);
    ...
    public Position<E> moveSubtree(Position<E> pOrig, Position<E> pDest) throws InvalidPositionException {
        ...
        if(parent== null){
            ...
            LinkedTreeIterator<E> it = new LinkedTreeIterator<>(origen);  //Si el destino es interno al origen
            while(it.hasNext()){
                if(destino == it.next()){
                    throw new InvalidPositionException("Invalid position");
                }
