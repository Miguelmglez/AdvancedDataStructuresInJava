...
import material.tree.maps.HashTableMapDH;
import material.tree.maps.InvalidKeyException;

public class HashTableMapTestDH11 extends TestCase {
	
	private HashTableMapDH<String, Integer> listin;
	...
	public void testSize() {
		listin = new HashTableMapDH<String, Integer>();	
	...
	public void testIsEmpty() {
		AbstractHashTableMap<String, Integer> listin = new HashTableMapDH<String, Integer>();
	...
	public void testRehash() {
		HashTableMapDH<Integer, Integer> listin1 = new HashTableMapDH<Integer, Integer>(10);
		...
		// Testing elements
		listin1 = new HashTableMapDH<Integer, Integer>(10);
		int cont2, cont;
