...
import material.tree.maps.Entry;
import material.tree.maps.HashTableMap;
import material.tree.maps.HashTableMapLP;
import material.tree.maps.InvalidKeyException;

public class HashTableMapTestLP11 extends TestCase {
	
	private HashTableMapLP<String, Integer> listin;
	...
	public void testSize() {
		listin = new HashTableMapLP<String, Integer>();	
	...
	public void testIsEmpty() {
		HashTableMap<String, Integer> listin = new HashTableMapLP<String, Integer>();
	...
	public void testRehash() {
		HashTableMapLP<Integer, Integer> listin1 = new HashTableMapLP<Integer, Integer>();
		...
		// Testing elements
		listin1 = new HashTableMapLP<Integer, Integer>();
		int cont2, cont;
